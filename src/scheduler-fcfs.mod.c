...
//  printf("drain_writes[%d] = %d\n", channel, drain_writes[channel]);
...
//      printf("credits_at_read[%d][%d] = %lld\n", channel, top_read->thread_id, credits_at_read[channel][top_read->thread_id]);
